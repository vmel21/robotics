...
//********* PERFORM AT Q1
 //now at location Q1; specify this for all part destinations in subsequent moves:
	...
	int ind = 0; 
	while ( ind < part_indices_missing.size()) {
		int n_missing_part = part_indices_missing[ind];
...
//********* PERFORM AT Q2
    ...
    droneControl.request.shipment_type = g_order.shipments[0].shipment_type;//"need_something_here";
