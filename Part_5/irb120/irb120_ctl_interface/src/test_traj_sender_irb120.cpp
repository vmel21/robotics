...
int main(int argc, char** argv) 
{
    ...
    trajectory_point2.time_from_start = ros::Duration(4.0); //2 seconds to arrive, from previous point
    trajectory_point3.time_from_start = ros::Duration(6.0); //2 seconds to arrive, from previous point
    trajectory_point4.time_from_start = ros::Duration(7.0); //2 seconds to arrive, from previous point
    trajectory_point5.time_from_start = ros::Duration(9.0); //2 seconds to arrive, from previous point
    trajectory_point6.time_from_start = ros::Duration(11.0); //2 seconds to arrive, from previous point  
     new_trajectory.header.stamp = ros::Time::now();
   
     trajectory_point1.positions[0] = 2.0;
     trajectory_point1.positions[1] = .4;
     trajectory_point1.positions[2] = 0.6;
     
     trajectory_point2.positions[0] = 4;
     trajectory_point2.positions[1] = .8;
     trajectory_point2.positions[2] = .4;
     
     trajectory_point3.positions[0] = 5;
     trajectory_point3.positions[1] = 1;
     trajectory_point3.positions[2] = .5;
     
     trajectory_point4.positions[0] = 7;
     trajectory_point4.positions[1] = .8;
     trajectory_point4.positions[2] = .7;
     
     trajectory_point5.positions[0] = 10;
     trajectory_point5.positions[1] = 1;
     trajectory_point5.positions[2] = .5;
     
     trajectory_point6.positions[0] = 12;
     trajectory_point6.positions[1] = 1.5;
     trajectory_point6.positions[2] = .4;    
